...
<?php
  $bg = array('BGimage1.jpg', 'BGimage2.jpg', 'BGimage3.jpg', 'BGimage4.jpg'); // array of filenames
...
.shadow-box  {
background-image: url('/sites/all/themes/wrexham_cemetery/img/<?php echo $selectedBg; ?>');
}

</style>

  <style> @import url('https://fonts.googleapis.com/css?family=Alegreya+Sans+SC:400,700|Alegreya+Sans:400,400i,700,700i,800|Quintessential');
</style>
